...
public class SlimefallingProcedure {
	public static void execute(LevelAccessor world) {
		{
			List<? extends Player> _players = new ArrayList<>(world.players());
			for (Entity entityiterator : _players) {
				if (entityiterator instanceof Player _player && !_player.level.isClientSide())
					_player.displayClientMessage(new TextComponent("\u53F2\u83B1\u59C6\u96E8"), (true));
							...
							if (Math.random() < 0.6) {
								if (world instanceof ServerLevel _level)
									_level.getServer().getCommands().performCommand(
											...
											"/summon minecraft:slime ~ ~1 ~ {FallDistance:-255,Size:1}");
							}
							if (Math.random() < 0.4) {
								if (world instanceof ServerLevel _level)
									_level.getServer().getCommands().performCommand(
											new CommandSourceStack(CommandSource.NULL,
													new Vec3((entityiterator.getX() + Mth.nextDouble(new Random(), -32, 32)),
															...
															(entityiterator.getZ() + Mth.nextDouble(new Random(), -32, 32))),
													Vec2.ZERO, _level, 4, "", new TextComponent(""), _level.getServer(), null).withSuppressedOutput(),
											"/summon minecraft:slime ~ ~1 ~ {FallDistance:-255,Size:2}");
							}
							if (Math.random() < 0.15) {
								if (world instanceof ServerLevel _level)
									_level.getServer().getCommands().performCommand(
											new CommandSourceStack(CommandSource.NULL,
													new Vec3((entityiterator.getX() + Mth.nextDouble(new Random(), -32, 32)),
															...
															(entityiterator.getZ() + Mth.nextDouble(new Random(), -32, 32))),
													Vec2.ZERO, _level, 4, "", new TextComponent(""), _level.getServer(), null).withSuppressedOutput(),
											"/summon minecraft:slime ~ ~1 ~ {FallDistance:-255,Size:3}");
							}
							if (Math.random() < 0.01) {
								if (world instanceof ServerLevel _level)
									_level.getServer().getCommands().performCommand(
											new CommandSourceStack(CommandSource.NULL,
													new Vec3((entityiterator.getX() + Mth.nextDouble(new Random(), -32, 32)),
															...
															(entityiterator.getZ() + Mth.nextDouble(new Random(), -32, 32))),
													Vec2.ZERO, _level, 4, "", new TextComponent(""), _level.getServer(), null).withSuppressedOutput(),
											"/summon minecraft:slime ~ ~1 ~ {FallDistance:-255,Size:5}");
							}
